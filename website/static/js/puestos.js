...
var socket = io.connect('http://10.0.17.52:5000');  // Reemplaza con la URL de tu servidor Socket.IO
...
const actualizarTabla = () => {
    ...
    xhr.open('GET', 'http://10.0.17.52:5000/api/actualizar_tabla' + '?id_user=' + encodeURIComponent(id_user.value)); // Replace with your API endpoint
